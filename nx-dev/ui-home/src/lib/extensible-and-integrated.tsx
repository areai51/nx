...
function Graph(): JSX.Element {
  return (
    <div className="wrapper relative my-8 flex h-full flex-col items-center space-y-12 overflow-hidden lg:flex-row">
      <div
      ...
      <div className="z-10 overflow-hidden rounded-lg border border-gray-200 shadow dark:border-slate-700 lg:w-[690px]">
        ...
        <div className="w-full bg-gray-700 dark:hidden">
...
function Plugins(): JSX.Element {
  return (
    <div className="wrapper my-8 grid h-full gap-12 md:grid-cols-2 lg:grid-cols-3">
...
function VscodeIntegration(): JSX.Element {
  ...
  return (
    <div className="wrapper my-8 grid h-full items-center gap-16 md:grid-cols-2 lg:grid-cols-3">
